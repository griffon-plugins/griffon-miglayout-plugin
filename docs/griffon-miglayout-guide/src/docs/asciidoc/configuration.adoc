...
----
dependencies {
    api 'com.miglayout:miglayout-swing:{miglayout-version}'
}
----
...
----
dependencies {
    api '{project-group}:griffon-miglayout-javafx:{project-version}'
}
----
...
----
dependencies {
    api '{project-group}:griffon-miglayout-swing-groovy:{project-version}'
}
----
...
----
dependencies {
    api '{project-group}:griffon-miglayout-javafx-groovy:{project-version}'
}
----

== Maven

First configure the `griffon-miglayout-plugin` BOM in your POM file, by placing the following
