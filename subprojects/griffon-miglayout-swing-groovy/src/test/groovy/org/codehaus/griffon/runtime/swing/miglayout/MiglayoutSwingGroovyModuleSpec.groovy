 ...
 */
class MiglayoutSwingGroovyModuleSpec extends Specification {
    static {
    ...
    def 'Builder customizer is configured correctly'() {
        ...
        then:
        builder.factories.containsKey('migLayout')
        builder.factories.migLayout.class == LayoutFactory
        builder.factories.migLayout.beanClass == MigLayout
    }
